...
import { ImageIcon, Send, X, Square } from 'lucide-react';
  ...
  return (
    <div className="p-4 border-t border-border/40 bg-card/40">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button 
          onClick={handleSend} 
          disabled={!isResponding && (disabled || (!content.trim() && !image))}
          className="rounded-full h-11 w-11 transition-all hover:scale-[1.05] bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white shadow-lg shadow-purple-500/20"
          size="icon"
        >
          {isResponding ? (
